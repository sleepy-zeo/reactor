...
net::srst::EpollPoller::EpollPoller()
...
void net::srst::EpollPoller::poll(int timeoutMs, std::vector<Channel*>* activeChannels) {
...
bool net::srst::EpollPoller::update(int operation, net::srst::Channel* channel) {
    epoll_event event{};
...
bool net::srst::EpollPoller::updateChannel(net::srst::Channel* channel) {
...
bool net::srst::EpollPoller::removeChannel(net::srst::Channel* channel) {
