...
void net::srst::setReuseAddr(int socket_fd, bool on) {
    int optval = on ? 1 : 0;
...
void net::srst::setReusePort(int socket_fd, bool on) {
    int optval = on ? 1 : 0;
...
void net::srst::setNoBlock(int socket_fd) {
    // non-block
...
void net::srst::setCloseOnExec(int socket_fd) {
    // close-on-exec
