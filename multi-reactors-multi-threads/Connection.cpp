...
net::mrmt::Connection::Connection(net::mrmt::EventLoop* loop, std::string name, int socketFd)
        : m_bufferIn{}
        , m_bufferOut{} {
...
void net::mrmt::Connection::handleRead() {
    int savedErrno = 0;
...
void net::mrmt::Connection::handleWrite() {
...
void net::mrmt::Connection::handleError() {
    ACSDK_DEBUG0(LX(__func__).d("name", m_name).d("error", errno));
    handleClose();
}

void net::mrmt::Connection::handleClose() {
...
void net::mrmt::Connection::forceClose() {
    ACSDK_DEBUG(LX(__func__));
    handleClose();
}

int net::mrmt::Connection::getSocketFd() {
