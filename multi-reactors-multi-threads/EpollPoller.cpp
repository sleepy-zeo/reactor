...
net::mrmt::EpollPoller::EpollPoller()
...
void net::mrmt::EpollPoller::poll(int timeoutMs, std::vector<Channel*>* activeChannels) {
...
bool net::mrmt::EpollPoller::update(int operation, net::mrmt::Channel* channel) {
    epoll_event event{};
...
bool net::mrmt::EpollPoller::updateChannel(net::mrmt::Channel* channel) {
...
bool net::mrmt::EpollPoller::removeChannel(net::mrmt::Channel* channel) {
